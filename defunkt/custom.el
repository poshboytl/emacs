...
(custom-set-variables
 ...
 '(default-frame-alist (quote ((tool-bar-lines . 0) (foreground-color . "black") (background-color . "white") (menu-bar-lines . 1) (font . "-apple-DejaVu_Sans_Mono-medium-normal-normal-*-16-*-*-*-m-0-iso10646-"))))
